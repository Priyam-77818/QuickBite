...
<div className='w-full h-auto flex flex-wrap gap-6 justify-center'>
  {searchItems.map((item)=>(
    <FoodCard data={item} key={item._id}/>
      ...
      {searchItems && searchItems.length===0 && (
        <div className='w-full max-w-6xl flex flex-col gap-3 items-center p-5 bg-white shadow-md rounded-2xl mt-4'>
          <h1 className='text-gray-900 text-2xl font-semibold'>No items found</h1>
          <p className='text-gray-500'>Try searching with a different name or category</p>
        </div>
      )}
